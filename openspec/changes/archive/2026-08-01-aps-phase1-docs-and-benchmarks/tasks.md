...
- [x] 2.2 Implement 6 inner @State classes, each setting up Direct, Java Proxy, APS, and CGLib proxies for one scenario
...
- [x] 2.5 Verify existing APS tests still pass (`mvn test -Dtest=APSFunctionalTest`)
...
- [x] 3.3 Calculate APS vs CGLib and APS vs JavaProxy speedup ratios per scenario
...
- [x] 4.3 Add APS vs CGLib feature comparison table
...
- [x] 6.1 Write CGLib → APS migration section with before/after code examples
- [x] 6.2 Write Java Proxy → APS migration section with before/after code examples
- [x] 6.3 Add feature comparison table covering APS, CGLib, and Java Proxy
